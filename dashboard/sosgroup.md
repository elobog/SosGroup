...
- **🔴 Pendiente (alta prioridad, hallazgo 2026-09-21):** commitear un script de deploy (`create_system = 3` vía Python `zipfile`) al repo — segundo incidente idéntico de assets rotos en QA por usar `Compress-Archive`/`ZipFile.CreateFromDirectory`, el fix solo vive documentado en bitácoras y no hay gate automático que lo fuerce.
